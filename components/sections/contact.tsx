...
import ContactExperience from '@/components/contact/ContactExperience'; // Assuming this is the correct import path
    ...
    <section id="contact" className="py-20 bg-muted/30">
      <div className="container px-4 mx-auto sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <Card className="p-8 transition-all duration-300 border-0 shadow-xl bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 hover:shadow-2xl glass">
