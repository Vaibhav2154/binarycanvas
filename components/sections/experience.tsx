...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      color: "bg-[#00D4FF]",
      achievements: [
        "Organizing hands-on workshops on in demand skills for in-depth learning",
        "Conducting engaging events: Bermuda Triangle, Smack D Bug, Track Back",
        "Providing comprehensive Linux and programming education",
        "Engaging participants in challenging problem-solving activities"
      ]
    },
    {
  ...
  return (
    <section id="experience" className="relative py-20 bg-[#FF6B9D] brutal-stripes overflow-hidden">
      ...
      <div className="absolute hidden w-16 h-16 bg-white border-4 border-black top-40 right-20 -rotate-6 md:block" />
          ...
          <div className="mb-16 text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 px-8 py-3 bg-white border-4 border-black shadow-brutal">
                ...
                <h2 className="text-3xl font-black uppercase sm:text-4xl">EXPERIENCE</h2>
              </div>
            </motion.div>
            <p className="inline-block max-w-xl px-6 py-2 mx-auto text-lg font-bold bg-white border-4 border-black shadow-brutal-sm">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                {/* Type badge */}
                <Badge className="mb-4 text-white bg-black">{exp.type}</Badge>

                {/* Achievements */}
                <div className="pt-4 space-y-2 border-t-4 border-black">
